...
import React, {useState} from "react";
 ...
 export interface FilterObj {
     handleLocationValue: (type: string, value: string | object) => void;
}
export default function MateList() {
    ...
    const handleLocationValue = (type : string, value : string | object) => {
        setStateValue(
            {
                ...stateValue,
                [type] : value,
    ...
    return (
        <section className={style.mateWrapper}>
            <MateFilter handleLocationValue={handleLocationValue}/>
            55개의 개시글
